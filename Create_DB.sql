...
-- -----------------------------------------------------
-- Table `mydb`.`ZabiegiOpis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ZabiegiOpis` (
  `idZabiegiOpis` INT NOT NULL AUTO_INCREMENT,
  `idLekiiMaterialy` INT NOT NULL,
  `Status` VARCHAR(45) NOT NULL,
  `Nazwa` VARCHAR(45) NOT NULL,
  `Opis` VARCHAR(360) NULL,
  PRIMARY KEY (`idZabiegiOpis`),
  INDEX `idLekiIMaterialy_idx` (`idLekiiMaterialy` ASC) VISIBLE,
  CONSTRAINT `idLekiIMaterialy`
    FOREIGN KEY (`idLekiiMaterialy`)
    REFERENCES `mydb`.`LekiIMaterialy` (`idLekiIMaterialy`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`Zabiegi` (
  ...
  `idZabiegiOpis` INT NOT NULL,
  `idWizyty` INT NOT NULL,
  PRIMARY KEY (`idZabiegi`),
  INDEX `idZabiegiOpis_idx` (`idZabiegiOpis` ASC) VISIBLE,
  INDEX `idWizyty_idx` (`idWizyty` ASC) VISIBLE,
  CONSTRAINT `idZabiegiOpis`
    FOREIGN KEY (`idZabiegiOpis`)
    REFERENCES `mydb`.`ZabiegiOpis` (`idZabiegiOpis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idWizyty`
    FOREIGN KEY (`idWizyty`)
    REFERENCES `mydb`.`Wizyty` (`idWizyty`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
